...
AZURE_LOGGER_IDENTITY_NOT_FOUND = "AZURE_LOGGER_IDENTITY_NOT_FOUND"

AZURE_LOGGER_IDENTITY_MISSING_BLOB_CONTRIBUTOR = "AZURE_LOGGER_IDENTITY_MISSING_BLOB_CONTRIBUTOR"
