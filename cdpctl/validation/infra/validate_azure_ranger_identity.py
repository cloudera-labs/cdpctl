...
@pytest.mark.azure
@pytest.mark.infra
def azure_ranger_data_contributor_validation(
    config: Dict[str, Any],
    auth_client: AuthorizationManagementClient,
    resource_client: ResourceManagementClient,
) -> None:  # pragma: no cover
    """Azure Ranger Identity has the Storage Container Contributor Role."""  # noqa: D401,E501
    ...
    ranger_name: str = get_config_value(
